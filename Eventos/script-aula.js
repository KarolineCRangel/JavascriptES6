...
// elemento.addEventListener(event, callback, options(opcional))
...
//img.addEventListener('click', callback()); // undefined - nao fazer assim
...
function executarCallback(event) {
  const currentTarget = event.currentTarget; // this - referente ao item em que foi add o event
...
const linkExterno = document.querySelector('a[href^="http"]');//acha o primeiro link que começa com http.
